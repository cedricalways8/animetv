...
import LetterFilterSearch from './LetterFilterSearch'
const Anasayfa = () => {
  return (
    <>
          ...
          <div class="flex w-full dark:bg-gray-900 justify-center items-center">
            <div class="w-[150px] text-gray-900 dark:text-gray-100">
              <div class="relative group">
                <label class="text-xs text-gray-400">Select Category</label><button class="py-2.5 px-3 w-full md:text-sm text-site bg-transparent border border-dimmed  focus:border-brand focus:outline-none focus:ring-0 peer flex items-center justify-between rounded font-semibold">ss</button>
                <div
