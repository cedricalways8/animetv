        ...
        <>
            ...
            <div>
                <div class="flex flex-col ">
                    <div>fsdfdsfsdfsdf 34.BÖLÜM</div>
                        ...
                        <div class="flex  md:flex-row flex-col bg-blue-600 p-2 gap-3 " >
                            <div class=" bg-orange-700 place-items-center basis-4/12 " >
                                <div class="flex flex-col place-items-center gap-5 p-2">
                                    ...
                                    <div class="bg-green-500 flex flex-col gap-3 ">
                            ...
                            <div class=" p-4 bg-gray-200 basis-6/12" >
                                <p class="break-all">
                            ...
                            <div class=" bg-red-500  basis-2/12 place-items-center p-10 overflow-y-auto max-h-4/5  ">
                                <div class="flex flex-col break-all gap-2">
                                    <div>Bölüm listesi</div>
                                    <a>abcdefghjklmnoprsştuüvyz</a>
                                    <a>12222222222222222222222222</a>
                                    <a>12222222222222222222222222</a>
                                    <a>12222222222222222222222222</a>
                                    <a>12222222222222222222222222</a>
                                    <a>12222222222222222222222222</a>
                    ...
                    <div class=" bg-yellow-500 flex flex-col justify-center p-5 gap-4">
                        <div className='flex flex-col gap-4'>
                            <div class="flex place-content-center bg-amber-300 gap-10">
                                <a href="#"
                                    ...
                                    <span class="ml-1 font-bold text-lg">Önceki Bölüm</span>
                                </a>
                                <a href="#"
                                    class="inline-flex items-center border border-indigo-300 px-3 py-1.5 rounded-md text-indigo-500 hover:bg-indigo-50">
                                    <span class="mr-1 font-bold text-lg">Sonraki Bölüm</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
                        ...
                        <div>
                            <div class="flex flex-col p-4 mx-auto max-w-xl mt-24">
                                ...
                                <div class="flex justify-end">
                                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded max-w-[100px]">Submit</button>
                                </div>
                            </div>
                        </div>
